            ...
            <div className="agentsCard">
                ...
                <div className="agentsCard__player">
                    ...
                    <div className='agentsCard__agent-skills'>
                        <img className='eventNone' width='247px' src={phoenixAbilities} alt=""/>
                    </div>
                </div>
            </div>
            <div className="agentsCard">
                ...
                <div className="agentsCard__player">
                    ...
                    <div className='agentsCard__agent-skills'>
                        <img className='eventNone' width='247px' src={jettAbilities} alt=""/>
                    </div>
                </div>
            </div>
            <div className="agentsCard">
                ...
                <div className="agentsCard__player">
                    ...
                    <div className='agentsCard__agent-skills'>
                        <img className='eventNone' width='247px' src={sovaAbilities} alt=""/>
                    </div>
                </div>
            </div>
            <div className="agentsCard">
                ...
                <div className="agentsCard__player">
                    ...
                    <div className='agentsCard__agent-skills'>
                        <img className='eventNone' width='247px' src={sageAbilities} alt=""/>
                    </div>
                </div>
            </div>
